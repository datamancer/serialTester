...
namespace Client.Networking
{
    class SocketClient
    {
        ...
        /**
         * Name: Read
         * Purpose: For non-gui based programs to output console content
         * Parameters: N/A
         * Returns: void
         */
        public string Read()
        ...
        public void Send(string msg_string)
        {
            ...
            try
            {
                ...
                // <EOF> is the sign for end of data, terminating server receipt callback.
                byte[] msg = Encoding.Unicode.GetBytes(msg_string + "<EOF>"); 
